...
> 이번 글에서는 ViewPager2 원리, 사용방법 그리고 적용할 때 주의해야할 점에 대하여 다뤄보도록 하겠습니다. 

### Reason for use ViewPager2

대부분 앱의 메인페이지는 Feed 형식으로 이뤄져 있습니다.

![image1_1](/assets/img/viewpager2/image1_1.png){: .center height="50%"}
...
![image1_5](/assets/img/viewpager2/image1_5.png){: .center width="50%"}
